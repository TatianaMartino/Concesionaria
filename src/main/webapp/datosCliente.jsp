    ...
    <form class="form" id="formAuto">
		...
		<div class="form-group">
			<label for="dni">dni:</label> <input type="text"
				...
				aria-describedby="emailHelp" placeholder="Ingrese su dni">
		</div>

		<div class="form-group">
			<label for="codigo_postal">codigo_postal</label> <input type="text"
				class="codigo_postal" id="codigo_postal" name="codigo_postal"
				aria-describedby="emailHelp" placeholder="Ingrese su codigo postal">
		</div>
				
		<div class="form-group">
			<label for="dato_tarjeta">dato_tarjeta: </label> <input type="text"
				class="dato_tarjeta" id="dato_tarjeta" name="dato_tarjeta" placeholder="Ingrese los datos de la tarjeta">
		</div>
